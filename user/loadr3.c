...
void loadr3(){
    ...
    p1->eax = (uint32_t)0;
    p1->ebp = (uint32_t)process1->stack_top;
    ...
    p2->eax = (uint32_t)0;
    p2->ebp = (uint32_t)process2->stack_top;
    ...
    p3->eax = (uint32_t)0;
    p3->ebp = (uint32_t)process3->stack_top;
    ...
    p4->eax = (uint32_t)0;
    p4->ebp = (uint32_t)process4->stack_top;
    ...
    p5->eax = (uint32_t)0;
    p5->ebp = (uint32_t)process5->stack_top;
