...
void help(char *str, char* extra_arg){
    println(itoa((int)strlen(extra_arg)));
    if(((int)strlen(str)==1||(int)strlen(str)==2)&&strlen(extra_arg)<=2){//only the argument string contains \r and \n
        ...
        else if(strcmp(str,"date")==0 && strlen(extra_arg)<=1){
